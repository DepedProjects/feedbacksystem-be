...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'users' | 'submitters' | 'serviceFeedback' | 'feedbackQuestion' | 'services' | 'serviceKind' | 'logs' | 'categories' | 'questions' | 'offices'
  ...
  interface ServiceFeedbackFieldRefs {
    ...
    readonly age: FieldRef<"ServiceFeedback", 'Int'>
  ...
  export type ServiceFeedbackWhereInput = {
    ...
    age?: IntNullableFilter<"ServiceFeedback"> | number | null
  ...
  export type ServiceFeedbackScalarWhereWithAggregatesInput = {
    ...
    age?: IntNullableWithAggregatesFilter<"ServiceFeedback"> | number | null
